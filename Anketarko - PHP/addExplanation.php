...
<?php include_once 'header.php'; ?>
    <main class="m-5">
        <h1 class="h3">Dodaj novo objašnjenje:</h1>
        <form action="" method="post">
            <div class="form-group">
                <label for="section">Naslov: </label>
            ...
            <div class="text-center">
                <button class="btn btn-success btn-lg" type="submit" id="btn-submit" name="addExp">Dodaj</button>
