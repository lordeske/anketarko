...
<?php include_once 'header.php'; ?>
    <main class="m-5">
        ...
        <form action="" method="post">
            ...
            <div>
                <button class="btn btn-primary btn-lg" type="submit" id="btn-submit" name="updExp">Ažuriraj</button>
                <a href="manageHome.php" id="btn_back" class="btn btn-secondary btn-lg">Nazad</a>
            </div>
        </form>
    </main>
