...
<body>
    ...
    <main>
        <div class="container-fluid text-center bg text">
            <h1>Anketarko</h1>
            <p>Mjesto za kreiranje najboljih anketa</p>
            <div class="pad-top">
                <a href="#get-started" class="btn btn-success btn-lg">Počnimo</a>
            </div>
        </div>
        <div class="container-fluid text-center">
            <h2>O nama</h2>
            <p class="pad-top">Anektarko je veb sajt namjenjen za kreiranje anketa i rad sa njima</p>
        </div>
        <div class="container-fluid bg text-center" id="get-started">
            <h2 class="text">Kako Anketarko radi?</h2>
